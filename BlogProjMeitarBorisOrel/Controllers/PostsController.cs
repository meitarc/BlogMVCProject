...
namespace BlogProjMeitarBorisOrel.Controllers
{
    ...
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,UserID,PublishedDate,Title,Author_Name,Text,UrlImage,NumOfLikes")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,UserID,PublishedDate,Title,Author_Name,Text,UrlImage,NumOfLikes")] Post post)
        {
            if (id != post.ID)
            {
                return NotFound();
